prams.uwind = wind;
prams.vortStrength = vortStrength;
prams.sinkStrength = sinkStrength;
prams.dx = dx;
...
if saveData
  ...
  % Name_data = sprintf('dataset_%f.mat',prams.uwind);
  Name_data = sprintf('dataset_%f_%d.mat',prams.uwind, batch_iter);
